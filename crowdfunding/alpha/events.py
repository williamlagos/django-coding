...
from socialize.stream import Dropbox

class Events(Alpha):
    def __init__(self): pass
    def event_form(self,request):
        return render(request,'event.pug',{},content_type='text/html')
    ...
    def create_event(self,request):
        ...
        return render(request,'eventimage.pug',{'static_url':settings.STATIC_URL})
    ...
    def show_enroll(self,request):
        ...
        return render(request,'enroll.pug',{'static_url':settings.STATIC_URL,'value':event.value})
