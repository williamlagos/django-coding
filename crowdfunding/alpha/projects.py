...
from socialize.stream import StreamService
from feedly.models import Sellable
from .models import Promoted,Interest,Movement,Project

class Projects(Alpha):
    def __init__(self): pass
    def start_promoteapp(self, request):
        return render(request, "createapp.pug", {'static_url':settings.STATIC_URL}, content_type='text/html')
    def project_form(self, request):
        return render(request,'project.pug',{},content_type='text/html')
    ...
    def create_project(self, request):
        ...
        return render(request, 'projectvideo.pug', {'static_url':settings.STATIC_URL,
    ...
    def view_pledge(self,request):
        ...
        return render(request,'pledge.pug',{'value':difference},content_type='text/html')
...
class Movements(Alpha):
    ...
    def movement_form(self,request):
        ...
        return render(request,'movement.pug',{'keys':Interests[:10],'quantity':len(Interests)},content_type='text/html')
